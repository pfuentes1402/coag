...
class ValidateAddress extends Component {
    ...
    componentWillMount() {
        this.setState({
            location: this.props.location && this.props.location.Georeferencia ? this.props.location.Georeferencia : "",
            isShowAddress: false
        });
    }
    ...
    render() {
        ...
        //let georeferencia = data && data.Georeferencia ? data.Georeferencia : "";
        return (
                    ...
                    <div style={{ display: "flex", alignItems: "center" }}>
                        <FormControl className={classes.formControl1}>
                            <TextField
                                ...
                                value={this.state.location/*georeferencia*/}
