...
class Upload extends Component {
  ...
  componentWillMount () {
    this.uppy = new Uppy({ id: 'uppy1', autoProceed: true, debug: true  })
      .use(Tus, { endpoint: 'https://servicios.coag.es/api/expedientes/703378/AlmacenTemporalArchivos',
      meta:{Token: '/1PlvyfUpJ4qZusW0lehLx0SJ4Xk8Oor03yJOg8V1DEI7fFb2NHUvfi4Zg7xGGRRpFRo1TKeQkl29YlIxB9laA==',
    }})
      .use(GoogleDrive, { serverUrl: 'https://companion.uppy.io', })

    this.uppy2 = new Uppy({ id: 'uppy2', autoProceed: false, debug: true })
      .use(Tus, { endpoint: 'https://companion.uppy.io'  })
  }
