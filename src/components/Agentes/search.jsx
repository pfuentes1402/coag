    ...
    return (
        <div>
          <Paper className={`${classes.withoutRadius} text-center`}>
            <ValidatorForm ref="form" onSubmit={() => { this.handleSearch() }}>
                ...
                <Grid item xs={12} className="py-3">
                    <div style={{ display: "inline-flex", alignItems: "center" }}>
                        <Button color="primary" className={classes.button} disabled={this.state.isSearch}
                                onClick={() => {this.handleCancel()}}>
                            <Translate id="languages.generalButton.cancel" />
                            <Close />
                        </Button>
                        <Button variant="contained" color="primary"  className={classes.button} disabled={this.state.isSearch}
                                type="submit">
            ...
            {this.state.showSearchResult ? <Button color="primary" className={classes.button}
                    onClick={() =>{this.selectAgent({"Id_Entidad": -1,  "Id_Tipo_Entidad": 1,  "Id_Autonomia": 71,
                        "Id_Pais": 100}, true)}}>
